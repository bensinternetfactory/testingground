...
Card CTAs are full-width pill buttons using canonical `CtaLink` (`size="sm"`) while preserving the historical `program-cards` section analytics identity without carrying wrapper-era `cardId` compatibility.
