...
/* ── Custom FAQs (render before shared core) ─────────────────────── */
...
const allFaqs = [...customFaqs, ...equipmentFaqCore];

/* ── Financing Offers Splits ─────────────────────────────────────── */

const USED_FINANCING_OFFERS_PRIMARY: FinancingOffersSplitConfig = {
  left: {
...
const USED_FINANCING_OFFERS_SECONDARY: FinancingOffersSplitConfig = {
  left: {
...
const USED_PURCHASE_AND_TERMS: PurchaseAndTermsConfig = {
  sectionHeading: {
    ...
    cards: [
      {
        ...
        iconAlt: "Dealer icon",
        badgeLabel: "For Sale",
        sampleListing: "2022 Kenworth T270 Rollback",
        samplePrice: "$79,500",
      },
      {
        id: "fbmp",
        ...
        badgeLabel: "For Sale",
        sampleListing: "2018 Ford F-550 Wrecker",
        samplePrice: "$48,000",
      },
      {
        id: "auction",
        ...
        badgeLabel: "For Sale",
        sampleListing: "2016 Peterbilt 388 Heavy Wrecker",
        samplePrice: "$115,000",
      },
      {
        id: "private",
        ...
        badgeLabel: "For Sale",
        sampleListing: "2019 Freightliner M2 Rollback",
        samplePrice: "$58,500",
      },
    ],
  },
...
export const usedTowTruckFinancingPageConfig: EquipmentFinancingPageConfig = {
  ...
  financingOffers: USED_FINANCING_OFFERS_PRIMARY,
  financingOffersSecondary: USED_FINANCING_OFFERS_SECONDARY,
  trustBridge: SHARED_TRUST_BRIDGE_CONFIG,
  purchaseAndTermsSecondary: USED_PURCHASE_AND_TERMS,
  faqSection: {
    eyebrow: "FAQ",
    heading: "Used tow truck financing questions, straight answers.",
    faqs: allFaqs,
  },
  faqSchema: buildFaqSchema(allFaqs),
