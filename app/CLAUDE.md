...
`app/page.tsx` is the primary TowLoans landing page. It is a server-rendered
...
```tsx
import Homepage01 from "@/app/page";
```
...
- Prefer editing section components only when layout or interaction changes are
  required.
- Do not inline section markup into `app/page.tsx`.
...
- `app/page.tsx` is a server route component
