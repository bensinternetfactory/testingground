...
This guide is for AI tools working on `app/page.tsx` or moving it into another
project. Optimize for portability, reuse, and preserving the current funnel
structure.

## What This Route Is

`app/page.tsx` is the homepage assembly layer for the TowLoans front end. It is
...
1. Read `app/page.tsx` first to confirm current section order and route-level
   responsibilities.
...
- treat `app/page.tsx` as a portable route shell
...
- Funnel/order change: edit `app/page.tsx`
